...
export const dictionary = {
    es: {
        ...
        genkit: {
            ...
            loading: "Escribiendo...",
            responses: {
                default: "Gracias por tu consulta. Un especialista se pondrá en contacto contigo pronto.",
                ...
                askEmail: "¿Te gustaría recibir más información detallada? Por favor, escribe tu correo electrónico.",
                emailReceived: "¡Gracias! Hemos recibido tu correo. Un especialista te contactará a la brevedad.",
