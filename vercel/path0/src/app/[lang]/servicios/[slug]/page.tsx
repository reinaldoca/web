...
import { Headphones, CloudUpload, GitBranch, Blocks, ShieldCheck, Router, Network, Search, Lightbulb, Users, CheckCircle, Zap } from 'lucide-react';
...
const serviceIcons: { [key:string]: JSX.Element } = {
  ...
  'cloud-foundations': <Blocks className="h-10 w-10 text-primary" />,
...
const processIcons: { [key: string]: JSX.Element } = {
  ...
  implementation: <Blocks className="h-6 w-6 text-primary" />,
